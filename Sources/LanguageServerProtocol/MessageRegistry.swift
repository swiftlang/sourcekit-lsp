...
public final class MessageRegistry {
      ...
      private(set) var methodToRequest: [String: _RequestType.Type] = {
            Dictionary(
                  uniqueKeysWithValues: builtinRequests.map { ($0.method, $0) })
      }()

      private(set) var methodToNotification: [String: NotificationType.Type] = {
            Dictionary(
                  uniqueKeysWithValues: builtinNotifications.map {
                        ($0.method, $0)
                  })
      }()
