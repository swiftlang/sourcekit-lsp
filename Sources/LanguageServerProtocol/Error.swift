...
public struct ErrorCode: RawRepresentable, Codable, Hashable {
      ...
      public static let serverErrorStart: ErrorCode = ErrorCode(
            rawValue: -32099)
      public static let serverErrorEnd: ErrorCode = ErrorCode(rawValue: -32000)
      public static let serverNotInitialized: ErrorCode = ErrorCode(
            rawValue: -32002)
      public static let unknownErrorCode: ErrorCode = ErrorCode(
            rawValue: -32001)
...
extension ResponseError {
      ...
      public static var cancelled: ResponseError = ResponseError(
            code: .cancelled, message: "request cancelled")

      public static var serverNotInitialized: ResponseError = ResponseError(
...
public struct MessageDecodingError: Error, Hashable {
      ...
      public init(
            code: ErrorCode, message: String, id: RequestID? = nil,
...
extension MessageDecodingError {
      public static func methodNotFound(
            _ method: String, id: RequestID? = nil,
            messageKind: MessageKind = .unknown
      ) -> MessageDecodingError {
            return MessageDecodingError(
                  code: .methodNotFound, message: "method not found: \(method)",
                  id: id, messageKind: messageKind)
      }

      public static func invalidRequest(
            _ reason: String, id: RequestID? = nil,
            messageKind: MessageKind = .unknown
      ) -> MessageDecodingError {
            return MessageDecodingError(
                  code: .invalidRequest, message: reason, id: id,
      ...
      public static func invalidParams(
            ...
            return MessageDecodingError(
                  code: .invalidParams, message: reason, id: id,
                  messageKind: messageKind)
      }
      ...
      public static func parseError(
            ...
            return MessageDecodingError(
                  code: .parseError, message: reason, id: id,
                  messageKind: messageKind)
      }
}
