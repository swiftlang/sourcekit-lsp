...
public struct CompletionItem: Codable, Hashable {
      ...
      public init(
            label: String, detail: String? = nil, sortText: String? = nil,
            filterText: String? = nil, textEdit: TextEdit? = nil,
            insertText: String? = nil,
            insertTextFormat: InsertTextFormat? = nil, kind: CompletionItemKind,
            deprecated: Bool? = nil
      ) {
            self.label = label
            self.detail = detail
