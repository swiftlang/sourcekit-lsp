...
extension SwiftLanguageService {
  ...
  ///   - enableSymbolGraph: Whether or not to ask sourcekitd for the complete symbol graph.
  ...
  func cursorInfo(
    ...
    let skreq = sourcekitd.dictionary([
      ...
      keys.retrieveSymbolGraph: enableSymbolGraph ? 1 : 0,
