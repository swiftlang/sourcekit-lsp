...
package struct GeneratedInterfaceDocumentURLData: Hashable, ReferenceURLData {
  ...
  package init(moduleName: String, groupName: String?, sourcekitdDocumentName: String, primaryFile: DocumentURI) {
